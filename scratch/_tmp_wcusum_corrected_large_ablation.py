...
out_root = repo / "figs" / "wcusum_corrected_large_ablation_20260417_seed10_np512"
out_root.mkdir(parents=True, exist_ok=True)
base_cmd = [sys.executable, "-m", "calib.run_synthetic_mechanism_figures", "--method-set", "wcusum_ablation", "--num-particles", "512", "--seeds", *[str(i) for i in range(10)]]
