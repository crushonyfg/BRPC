...
def main():
    ...
    if args.profile == "cpd_ablation":
        methods = {
            ...
            "BRPC-P": dict(type="bocpd", mode="single_segment", controller_name="none", use_discrepancy=False, bocpd_use_discrepancy=True, delta_update_mode="online_bpc_proxy_stablemean", delta_bpc_obs_noise_mode="sigma_eps", delta_bpc_predict_add_kernel_noise=False),
            "B-BRPC-P": dict(type="bocpd", mode="restart", use_discrepancy=False, bocpd_use_discrepancy=True, delta_update_mode="online_bpc_proxy_stablemean", delta_bpc_obs_noise_mode="sigma_eps", delta_bpc_predict_add_kernel_noise=False),
            "C-BRPC-P": dict(type="bocpd", mode="wcusum", controller_name="wcusum", controller_stat="log_surprise_mean", controller_wcusum_warmup_batches=3, controller_wcusum_window=4, controller_wcusum_threshold=0.25, controller_wcusum_kappa=0.25, controller_wcusum_sigma_floor=0.25, use_discrepancy=False, bocpd_use_discrepancy=True, delta_update_mode="online_bpc_proxy_stablemean", delta_bpc_obs_noise_mode="sigma_eps", delta_bpc_predict_add_kernel_noise=False),
            "BRPC-E": dict(type="bocpd", mode="single_segment", controller_name="none", use_discrepancy=False, bocpd_use_discrepancy=True, delta_update_mode="online_bpc_exact", delta_bpc_obs_noise_mode="sigma_eps", delta_bpc_predict_add_kernel_noise=False),
            "B-BRPC-E": dict(type="bocpd", mode="restart", use_discrepancy=False, bocpd_use_discrepancy=True, delta_update_mode="online_bpc_exact", delta_bpc_obs_noise_mode="sigma_eps", delta_bpc_predict_add_kernel_noise=False),
            "C-BRPC-E": dict(type="bocpd", mode="wcusum", controller_name="wcusum", controller_stat="log_surprise_mean", controller_wcusum_warmup_batches=3, controller_wcusum_window=4, controller_wcusum_threshold=0.25, controller_wcusum_kappa=0.25, controller_wcusum_sigma_floor=0.25, use_discrepancy=False, bocpd_use_discrepancy=True, delta_update_mode="online_bpc_exact", delta_bpc_obs_noise_mode="sigma_eps", delta_bpc_predict_add_kernel_noise=False),
            "BRPC-F": dict(type="bocpd", mode="single_segment", controller_name="none", use_discrepancy=False, bocpd_use_discrepancy=True, delta_update_mode="online_bpc_fixedsupport_exact", delta_bpc_obs_noise_mode="sigma_eps", delta_bpc_predict_add_kernel_noise=False),
            "B-BRPC-F": dict(type="bocpd", mode="restart", use_discrepancy=False, bocpd_use_discrepancy=True, delta_update_mode="online_bpc_fixedsupport_exact", delta_bpc_obs_noise_mode="sigma_eps", delta_bpc_predict_add_kernel_noise=False),
