...
def build_methods(profile: str) -> Dict[str, Dict]:
    ...
    if profile_name == "cpd_ablation":
        return {
            ...
            "C-BRPC-P": dict(base, mode="wcusum", controller_name="wcusum",
                                  ...
                                  delta_bpc_obs_noise_mode="sigma_eps",
                                  delta_bpc_predict_add_kernel_noise=False),
            "B-BRPC-E": dict(base, mode="restart",
                                 delta_update_mode="online_bpc_exact",
                                 delta_bpc_obs_noise_mode="sigma_eps",
                                 delta_bpc_predict_add_kernel_noise=False),
            "C-BRPC-E": dict(base, mode="wcusum", controller_name="wcusum",
                                  controller_stat="log_surprise_mean",
                                  controller_wcusum_warmup_batches=3,
                                  controller_wcusum_window=4,
                                  controller_wcusum_threshold=0.25,
                                  ...
                                  delta_bpc_obs_noise_mode="sigma_eps",
                                  delta_bpc_predict_add_kernel_noise=False),
            "B-BRPC-F": dict(base, mode="restart",
                                        delta_update_mode="online_bpc_fixedsupport_exact",
                                        delta_bpc_obs_noise_mode="sigma_eps",
                                        delta_bpc_predict_add_kernel_noise=False),
            "C-BRPC-F": dict(base, mode="wcusum", controller_name="wcusum",
                                         controller_stat="log_surprise_mean",
                                         controller_wcusum_warmup_batches=3,
                                         controller_wcusum_window=4,
                                         controller_wcusum_threshold=0.25,
    ...
    if profile_name == "cpd_ablation_plus":
        return {
            "BRPC-P": dict(base, mode="single_segment", controller_name="none",
                                delta_update_mode="online_bpc_proxy_stablemean",
                                delta_bpc_obs_noise_mode="sigma_eps",
                                delta_bpc_predict_add_kernel_noise=False),
            "B-BRPC-P": dict(base, mode="restart",
            ...
            "C-BRPC-P": dict(base, mode="wcusum", controller_name="wcusum",
                                  ...
                                  delta_bpc_obs_noise_mode="sigma_eps",
                                  delta_bpc_predict_add_kernel_noise=False),
            "BRPC-E": dict(base, mode="single_segment", controller_name="none",
                                delta_update_mode="online_bpc_exact",
                                delta_bpc_obs_noise_mode="sigma_eps",
                                delta_bpc_predict_add_kernel_noise=False),
            "B-BRPC-E": dict(base, mode="restart",
            ...
            "C-BRPC-E": dict(base, mode="wcusum", controller_name="wcusum",
                                  ...
                                  delta_bpc_obs_noise_mode="sigma_eps",
                                  delta_bpc_predict_add_kernel_noise=False),
            "BRPC-F": dict(base, mode="single_segment", controller_name="none",
                                       delta_update_mode="online_bpc_fixedsupport_exact",
                                       delta_bpc_obs_noise_mode="sigma_eps",
                                       delta_bpc_predict_add_kernel_noise=False),
            "B-BRPC-F": dict(base, mode="restart",
